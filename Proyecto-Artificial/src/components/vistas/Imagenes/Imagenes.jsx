...
export const Imagen = () => {
  ...
  const eliminarEmpleado = async id => {
    try {
      ...
      console.error(err);
      Swal.fire("Error", "Ocurrió un error al eliminar imagen", "error");
    }
  };
  const FuncionEliminar = id => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        eliminarEmpleado(id);
        Swal.fire("Eliminado", "La imagen ha sido removida", "success");
      }
    });
  };
                  ...
                  <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                      ...
                      <div className=" text-black flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                        <h3 className="title text-black">Agregar Imagen</h3>
                        <button
                        ...
                        <div>
                          ...
                          <div className="w-full sm:w-1/2">
                            <div className="mb-5">
                              <label
                                for="id_coleccion"
                                class="mb-3 block text-base font-medium text-[#263562] "
                              >
                                Colección
                              </label>
                              <select
                                id="id_coleccion"
                                class="w-full rounded-xl border bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#263562] focus:shadow-md"
                              >
                                <option></option>
                              </select>
                            </div>
              ...
              <div className="flex items-center md:justify-end pb-3 m-2">
                ...
                <div className="relative md:content-center">
                  ...
                  <input
                    ...
                    placeholder="        Ingrese título o nombre de colección"
                    value={busqueda}
                              ...
                              <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                  ...
                                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    {/*header*/}
                                    <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                      <h3 className="title">Editar Imagen</h3>
                                      <button
                                        className="p-1 ml-auto bg-transparent border-0 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
